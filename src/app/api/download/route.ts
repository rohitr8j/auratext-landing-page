...
const FILE_CONFIG = {
  main: {
    ...
    url: 'https://github.com/auratext-app/releases/releases/latest/download/AuraText-Setup-1.0.3.exe'
  },
  extension: {
    filename: 'AuraText-Extension.zip', 
    size: 'Coming Soon',
    description: 'Browser extension for Chrome, Edge, Firefox',
    url: 'https://github.com/auratext-app/releases/releases'
  }
};
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      url: config.url,
      githubReleases: 'https://github.com/auratext-app/releases/releases'
    });
